...
export default function SignInPage() {
  ...
  // Redirect to loading page if already signed in
  useEffect(() => {
    ...
    <div className="fixed inset-0 z-[100] bg-black flex items-center justify-center overflow-hidden">
      ...
      <AnimatePresence>
        <motion.div
          ...
          className="relative z-[200] flex items-center justify-center p-4"
        >
          <AnimatedMetalBorder
            ...
            borderRadius={16}
          >
            <div className="clerk-signin-wrapper rounded-2xl">
              {/* CSS overrides for Clerk SignIn component */}
              <style jsx global>{`
                .clerk-signin-wrapper .cl-rootBox,
                .clerk-signin-wrapper .cl-card,
                .clerk-signin-wrapper .cl-headerTitle,
                .clerk-signin-wrapper .cl-headerSubtitle,
                .clerk-signin-wrapper .cl-formFieldLabel,
                .clerk-signin-wrapper .cl-formFieldInput,
                .clerk-signin-wrapper .cl-formButtonPrimary,
                .clerk-signin-wrapper .cl-footerActionText,
                ...
                .clerk-signin-wrapper::-webkit-scrollbar {
                  width: 6px;
                }
                .clerk-signin-wrapper::-webkit-scrollbar-track {
                  background: transparent;
                }
                .clerk-signin-wrapper::-webkit-scrollbar-thumb {
                ...
                @media (max-width: 640px) {
                  ...
                  .clerk-signin-wrapper .cl-socialButtonsBlockButton {
                    padding: 0.5rem !important;
                  }
                  .clerk-signin-wrapper .cl-socialButtonsBlockButtonText {
                    font-size: 0.75rem !important;
                  }
                  .clerk-signin-wrapper .cl-card {
