...
const ON_CHAIN = {
  VAULT_PROGRAM: "JTX5uXTiZ1M3hJkjv5Cp5F8dr3Jc7nhJbQjCFmgEYA7",
  DEPIN_PROGRAM: "91SqqYLMi5zNsfMab6rnvipwJhDpN4FEMSLgu8F3bbGq",
  TRUST_PROGRAM: "79nQsecDspUWxvAMyJvK36EUty4yEoP5ssLvHZuNiugF",
  ...
  FOUNDER_WALLET: "FEUwuvXbbSYTCEhhqgAt2viTsEnromNNDsapoFvyfy3H",
  JOE_WALLET: "EFvgELE1Hb4PC5tbPTAe8v1uEDGee8nwYBMCU42bZRGk",
  XRPL_HOOK: "rLXCpNStZodh9HjXn5DyoSFMKies1vKBUG",
  ANODOS_DEX: "r21wnrTT2G52FcKrTBAb8hhn4aGSGn1eX",
}
...
const SECTIONS: { key: DocSection; label: string; icon: typeof BookOpen; tocItems: string[] }[] = [
  ...
  { key: "how-it-works", label: "How It Works", icon: Cpu, tocItems: ["Private Gaze Audit", "Opaque Proof", "MPP Payments", "USDC Bridge (XRP ↔ SOL)", "Vault NFT Receipts", "Xahau Hooks", "Staked Tiers"] },
  { key: "quick-start", label: "Quick Start", icon: Code2, tocItems: ["TypeScript SDK", "Python SDK", "Xaman (XRP)", "Response Shape"] },
  { key: "on-chain", label: "On-Chain", icon: Layers, tocItems: ["Solana Programs", "Token Addresses", "XRPL Addresses", "Explorer Links"] },
  { key: "architecture", label: "Architecture", icon: Terminal, tocItems: ["System Diagram", "Bridge Flow", "GENSYS Fee Split"] },
]
